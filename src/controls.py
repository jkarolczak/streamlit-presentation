...
with st.expander("Click to expand"):
    ...
    st.markdown(
        "Elements generated by Stremlit are arranged according to the execution order. If you want to mix the order you can use `st.container` or `st.empty` elements.")
    col1, col2 = st.columns(2)
    with col1:
